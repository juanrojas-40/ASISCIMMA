...
class EmailManager:
    ...
    def create_attendance_email(self, apoderado: str, estudiante: str, 
                               curso: str, fecha: str, presente: bool) -> tuple:
        """Crea el contenido del email de asistencia"""
            ...
            <div style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;">
                ...
                <div style="padding: 20px;">
                    ...
                    <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid {color};">
                        ...
                        <table style="width: 100%; border-collapse: collapse;">
                            ...
                            <tr>
                                <td style="padding: 8px 0; font-weight: bold;">📚 Curso:</td>
                                <td style="padding: 8px 0;">{curso}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="padding: 8px 0; color: {color}; font-weight: bold; font-size: 18px;">
                                    {estado}
                                </td>
                            </tr>
                        </table>
                    ...
                    <strong>Equipo Preuniversitario CIMMA</strong></p>
                </div>
                ...
                <div style="background-color: #f0f2f5; padding: 15px; border-radius: 0 0 10px 10px; text-align: center; font-size: 12px; color: #666;">
                    <p style="margin: 0;">
                        ...
                        Si tiene preguntas, contacte a la administración.
                    </p>
                </div>
            </div>
        </body>
    ...
    def send_attendance_emails(self, curso: str, fecha: str, 
                              attendance_data: Dict[str, bool]) -> Dict[str, Any]:
        """Envía emails de asistencia a todos los apoderados"""
    ...
    def send_bulk_emails(self, destinatarios: List[Dict[str, Any]], subject: str, 
                        body_template: str, is_html: bool = True) -> Dict[str, Any]:
        ...
        for i, destino in enumerate(destinatarios):
            try:
                # Verificar que el destino tiene email
                if "email" not in destino or not destino["email"]:
                    results["failed"] += 1
